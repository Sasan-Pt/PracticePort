    ...
    <Fragment>
      <div className="flex">
        <div className="flex justify-items-center items-center mt-28 shrink relative">
          <Link to="/Invalid">
            <video
              className="justify-items-center items-center brightness-percent hover:brightness-100"
              autoPlay
              muted
              src={vidUrl}
            ></video>
        ...
        <div className="flex justify-between cRes:flex-col">
          <div className="w-40p cRes:w-full cursor-view">
            <Link to="/Invalid">
              ...
              />
              <h2 className="text-white cursor-view">
          ...
          <div className="w-40p cRes:w-full cRes:mt-12 cursor-view">
            <Link to="Invalid">
              <img
                src="https://assets.weareadaptable.com/app/uploads/2022/04/14132332/phmg-thumb.jpg"

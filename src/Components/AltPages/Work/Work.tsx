...
const Work = () => {
  ...
  const pics1 = {
    ...
    right:
      "https://assets.weareadaptable.com/app/uploads/2022/04/14132332/phmg-thumb.jpg",
  };

  const pics2 = {
    left: "https://assets.weareadaptable.com/app/uploads/2020/08/28142110/bah-thumb.jpg",
    right:
      "https://assets.weareadaptable.com/app/uploads/2020/10/15142954/boop-cover.gif",
  };
